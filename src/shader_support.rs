...
#[inline(always)]
pub fn calculate_scaled_buffer_size(width: u32, height: u32, scale: u32) -> (u32, u32) {
    let width = (width as f64 / scale as f64).ceil() as u32;
    let height = (height as f64 / scale as f64).ceil() as u32;
    (width, height)
}
